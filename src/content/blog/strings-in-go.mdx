...
description: "In this post, we will talk about strings in Go and the operations we can perform on them. Through examples, we will see why the length of a string is not always the same as the number of characters."
date: 2022-11-20
