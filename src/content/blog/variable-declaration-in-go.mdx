...
description: "We will look at two ways to declare variables in Go. Through examples, we will see how Go determines their types and when we can use the shorter `:=` syntax."
date: 2022-08-14
